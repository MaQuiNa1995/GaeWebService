...
<form action="index.jsp">
	...
	<div>
		...
		<input name="nombrePedidoInput" type="text" value=""
			required="required">
	</div>
	<p>
	<div>
		<h1>Descripción Del Pedido:</h1>
		<input name="descripcionInput" type="text" value=""
			required="required">
	</div>
	<p>
	<div>
		<h1>Solicitante:</h1>
		<input name="solicitanteInput" type="text" value=""
			required="required">
	</div>
	<p>
	<div>
		<h1>Importe Máximo (En Euros):</h1>
		<input name="importeMaximoInput" type="number" value=0
			required="required">
	</div>
	<p>
	<div>
		...
		<%
			// Se hace una comprobación de si algun campo es nulo
			// (solo puede ser nulo cuando se inicia la pagina) para
			// evitar meter objetos basura en la base de datos
